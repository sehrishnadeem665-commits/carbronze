      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
          <div className="space-y-4">
            {[
              { icon: Mail, label: 'Email Us', value: 'support@carreaders.ai' },
              { icon: Phone, label: 'Phone Number', value: '+44 20 1234 5678' },
              { icon: MapPin, label: 'Office', value: 'Worldwide remote support team' },
              { icon: Clock, label: 'Availability', value: 'Mon–Fri, 9:00 AM – 6:00 PM GMT' },
            ].map((item, i) => (
